...
The guide assumes that you have prior coding experience, hopefully in Python. It is designed to use just introductory concepts. No Object Oriented Programming (OOP) are used so that students in particular that has completed their first course in code and know just variables, if statements, loops and functions will be able to follow along.
